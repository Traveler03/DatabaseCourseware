...
from tkinter import *
from interface.plant import plant_main_window
...
def show_add_staff_page(root):
    ...
    label.pack()
def open_main_window(root,user):
    # 创建主界面
    ...
    def show_info_page():
        plant_main_window(root,user)  # 打开新的界面
    # 创建按钮
    info_button = tk.Button(main_window, text="植物信息", width=button_width, height=button_height, padx=button_padx,
