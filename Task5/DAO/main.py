...
def zhiwuyuzhi():
    ...
    while True:
        ...
        if choice == "1":
            ...
            print("植物号 最大温度 最小温度 最大生长量 最小生长量 最大光照")
            result = dao.select()
            for item in result:
                print(item)
...
def jianceshebei():
    ...
    while True:
        ...
        if choice== "1":
            ...
            print("监测设备号   监测设备名称")
            result = equipment_dao_impl.selectall()
            for i in result:
                print(i)
        if choice =="0":
            break;
...
def jiancexinxi():
    ...
    while True:
        ...
        if choice == "1":
            ...
            print("查询结果：")
            print("记录号 地区            时间              植物号 温度  生长  光照  植物名称  植物别名")
            for row in result:
                print(row)
        elif choice == "5":
            print("记录号 地区            时间              植物号 温度  生长  光照  植物名称  植物别名")
            result = dao_impl.showshitu()
            for row in result:
                print(row)
        elif choice== "6":
            path=input("请输入文件路径名:")
...
def tongji():
    ...
    while True:
        ...
        if choice == "1":
            ...
            plant_id = input("请输入植物ID: ")
            max_value = dao.select_aggregate(at, plant_id, "max")
            ...
            while True:
                ...
                if attribute == "温度":
                    ...
                    print("请输入正确的属性名")
            plant_id = input("请输入植物ID: ")
            min_value = dao.select_aggregate(at, plant_id, "min")
            ...
            while True:
                ...
                if attribute == "温度":
                    ...
                    print("请输入正确的属性名")
            plant_id = input("请输入植物ID: ")
            avg_value = dao.select_aggregate(at, plant_id, "avg")
